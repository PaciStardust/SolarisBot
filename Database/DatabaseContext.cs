...
{
    internal sealed class DatabaseContext : DbContext //todo: [UPCOMING] bdays, temp channels, gif-ify, stats, steal nickname, docker support, light control, hydro reminders, user analysis, uptime, discord sink, embed gen, module editor
    {
