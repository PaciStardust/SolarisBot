            ...
            try
            {
                ...
                if (version < 1)
                {
                    var queries = new string[]{
                        ...
                        "CREATE TABLE Roles(RId INTEGER PRIMARY KEY, RgId INTEGER REFERENCES RoleGroups(RgId) ON DELETE CASCADE ON UPDATE CASCADE, Name TEXT NOT NULL DEFAULT \"\", UNIQUE(RgId, Name))",
