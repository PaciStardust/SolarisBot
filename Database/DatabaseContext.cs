            ...
            try
            {
                ...
                if (version < 1)
                {
                    var queries = new string[]{
                        ...
                        "CREATE TABLE RoleGroups(RgId INTEGER PRIMARY KEY AUTOINCREMENT, GId INTEGER REFERENCES Guilds(GId) ON DELETE CASCADE ON UPDATE CASCADE, Name TEXT NOT NULL DEFAULT \"\", AllowOnlyOne BOOL NOT NULL DEFAULT 0, Description TEXT NOT NULL DEFAULT \"\", UNIQUE(GId, Name))",
