            ...
            try
            {
                ...
                if (version < 1)
                {
                    var queries = new string[]{
                        ...
                        "CREATE TABLE Bridges(BridgeId INTEGER PRIMARY KEY AUTOINCEMENT, ChannelAId INTEGER NOT NULL DEFAULT 0, ChannelBId INTEGER NOT NULL DEFAULT 0, UNIQUE(ChannelAId, ChannelBId), CHECK(ChannelAId <> ChannelBId))"
                    };
