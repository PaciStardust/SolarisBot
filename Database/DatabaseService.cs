            ...
            try
            {
                ...
                if (version < 1)
                {
                    queries.AddRange(new List<string>()
                    {
                        ...
                        "CREATE TABLE InteractionRecords(InteractionRecordId INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, InteractionCreatedAt INTEGER NOT NULL DEFAULT 0, InteractionCompletedAt INTEGER NOT NULL DEFAULT 0, GuildId INTEGER NOT NULL DEFAULT 0, ChannelId INTEGER NOT NULL DEFAULT 0, UserId INTEGER NOT NULL DEFAULT 0, InteractionId INTEGER NOT NULL DEFAULT 0, Success BOOL NOT NULL DEFAULT 0, ModuleName TEXT NOT NULL DEFAULT \"\", CommandGroupName TEXT NOT NULL DEFAULT \"\", CommandName TEXT NOT NULL DEFAULT \"\", MethodName TEXT NOT NULL DEFAULT \"\", Arguments TEXT NOT NULL DEFAULT \"\", ErrorType TEXT NOT NULL DEFAULT \"\", ErrorMessage TEXT NOT NULL DEFAULT \"\", ErrorTrace TEXT NOT NULL DEFAULT \"\", CreatedAt INTEGER NOT NULL DEFAULT (strftime('%s', 'now')), UpdatedAt INTEGER NOT NULL DEFAULT (strftime('%s', 'now')), UNIQUE(InteractionId))",
